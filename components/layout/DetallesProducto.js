...
const DetallesProducto = ({ producto }) => {
  ...
  /* var time = new Date(creado).toDateString(); */
  ...
  useEffect( () => {
    const pluralOSingular = () => {
      ...
      if(resultado === 0){
        guardarPalabra("Unos momentos")
      }
    }
    pluralOSingular()
  },[])
  /* console.log(hoy)
  console.log(diacreado)

  var fecha = new Date(creado);
  var options = { year: 'numeric', month: 'long', day: 'numeric' };

  var time =  fecha.toLocaleDateString("es-ES", options) */
  ...
  <Producto>
      ...
      <DescripcionProducto>
        ...
        <div>
            ...
            <p>Publicado hace: {resultado} {palabra}</p>
        </div>
      </DescripcionProducto>
      <Votos>
        <div>
